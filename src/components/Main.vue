<template>
  <section class="main">
    ...
    <div class="notes__wrapper">
      ...
      <div v-for="(item, index) in notesList" :key="item._id" class="note" :style="'border-color:' + (isCompleted(item.todos) ? 'green' : 'red')">
        ...
        <hr>
        <ul class="note__list">
          <li v-for="(todo, index) in item.todos" :key="index" class="note__list_item" :style="'color:' + (todo.completed ? 'green' : 'red')">
            {{ todo.title }}
          </li>
        </ul>
      </div>
